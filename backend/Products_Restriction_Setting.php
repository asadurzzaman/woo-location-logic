...
/**
 *
 * @class WC_products_restriction_setting
...
global $woocommerce;
global $product;
if( !class_exists('WC_products_restriction_setting')){
    class WC_products_restriction_setting{
        var $WC_user_country = "";
        /**
         * @since  1.0.0
         * @return WC_products_restriction_setting
         */
        ...
        */
        function init(){
                ...
                add_action('woocommerce_product_meta_start', array($this, 'wc_meta_area_message'));
        ...
        {
            $restriction =  get_post_meta($product_id, '_wcll_country_restriction_type_role', true);
            if ('specific' == $restriction || 'excluded' == $restriction) { 
                $countries = get_post_meta($product_id, '_wc_restricted_countries', true);
        ...
        */
         ...
         * @since 1.0.0
         */
        function wc_default_message()
        { 
            $message = __('This product is not available in your country.', 'location-logic');
            return $message;
        }
        ...
        { 
            $message = $this->wc_default_message();
            $message = apply_filters('wc_no_soup_for_you', $message);
            return "<div class='woocommerce-variation-add-to-cart variations_button'><p class='wc-no-soup-for-you stock out-of-stock'>" . $message . '</p></div>';
        }
        ...
        */
        ...
        { 
            ...
            $message = __('wcll requires WooCommerce 3.0.0 or higher.', 'location-logic');

            printf('<div class="%1$s"><p>%2$s</p></div>', esc_attr($class), esc_html($message));
        } 
    }
    new WC_products_restriction_setting();
